...
#	define DEFAULT_GRANULARITY (1*512*1024)
#else
...
#endif*/ //maks: if use this PREACTION2 will cause deadlock
/*#define FORCEINLINE*/
#include "malloc.c.h"
...
#define MAXTHREADSINPOOL 4 //16 //maks
#endif
...
#define THREADCACHEMAX 0 //8192 //maks
#endif
#if 0
...
#else
 #define TLSALLOC(k)	(*(k)=TlsAlloc(), (DWORD)0xFFFFFFFF==*(k))
#endif
