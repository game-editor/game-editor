...
#define xmalloc(N)          EiC_ymalloc(__F1LE__,__LINE__,N)
#define xcalloc(N,M)	    EiC_ycalloc(__F1LE__,__LINE__,N,M)
#define xrealloc(N,M)	    EiC_yrealloc(__F1LE__,__LINE__,N,M)
#define xfree(N)	    EiC_yfree(__F1LE__,__LINE__,N)
#define xmark(N,M)          EiC_ymark(__F1LE__,__LINE__,N,M)
#define xmemcheck()         ymemcheck(__F1LE__,__LINE__)
