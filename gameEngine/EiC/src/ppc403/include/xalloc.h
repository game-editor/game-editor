...
#define xmalloc(N)          ymalloc(__F1LE__,__LINE__,N)
#define xcalloc(N,M)	    ycalloc(__F1LE__,__LINE__,N,M)
#define xrealloc(N,M)	    yrealloc(__F1LE__,__LINE__,N,M)
#define xfree(N)	    yfree(__F1LE__,__LINE__,N)
#define xmark(N,M)          ymark(__F1LE__,__LINE__,N,M)
