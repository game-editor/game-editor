...
void DrawOGLTexQuad(GLenum mode, GLshort *vertices, GLfixed *texCoords, int nVerticeCoords); //maks
void DrawOGLQuad(GLenum mode, GLshort *vertices, int nVerticeCoords); //maks
void DrawOGLLine(GLshort *vertices, int nVerticeCoords); //maks

void InitNew2DStrip(); //maks
void Push2DQuadStrip(GLuint textureId, GLshort *vertices, GLfixed *texCoords); //maks
void Draw2DStrip(); //maks
...
#ifndef HAVE_OPENGL
#define HAVE_OPENGL //maks
#endif

#include "../src/video/SDL_sysvideo.h" //maks
