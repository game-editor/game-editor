...
#ifdef SAVE_RCSID
static char rcsid =
 "@(#) $Id: SDL_surface.c,v 1.17 2004/02/19 21:13:24 slouken Exp $";
#endif
			...
			Uint32 Rmask, Uint32 Gmask, Uint32 Bmask, Uint32 Amask)
{
...
#ifndef GP2X_HARDWARE_BLITTER //maks: no use hw blitter now. (bad repaint in some games) GP2X //maks: there is no screen at the shadow creation time, but make sure GP2X always will have hardware surfaces
		flags &= ~SDL_HWSURFACE;
#endif
	}
	...
	if ( ((flags&SDL_HWSURFACE) == SDL_SWSURFACE) || 
				(video && video->AllocHWSurface(this, surface) < 0) ) //maks
	{
