...
#ifdef SAVE_RCSID
static char rcsid =
 "@(#) $Id: SDL_memops.h,v 1.4 2002/03/06 11:23:03 slouken Exp $";
#endif
...
//Why need this on Pocket PC? Alignment errors?
//Error with colors: (0, 180, 146), (0, 255, 0), (0, 113, 32)
//Draw vertical lines with background with this colors
//#define SDL_memset4(dst, val, len) memset(dst, val, (len) << 2) 
//#else
#define SDL_memset4(dst, val, len)		\
do {						\
	unsigned _count = (len);		\
