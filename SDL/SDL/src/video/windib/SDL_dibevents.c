...
SDLKey VK_keymap[SDLK_LAST]; //maks
...
extern BOOL g_bWindowActive; //maks: Disable the Windows Key 
 ...
 DIB_HandleMessage(_THIS, HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_EXITSIZEMOVE: //maks
		...
		default: {
			 ...
			 */
			} else if (userWindowProc && !bInWinMessage) { //maks
