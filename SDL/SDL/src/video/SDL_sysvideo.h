...
#define SDL_PROC(ret,func,params) ret (GL_WINAPI *func) params; //maks
...
#undef SDL_PROC
	...
	*/
	...
	void (*freeVideoDevice)(_THIS); //maks
};
#undef _THIS
...
#ifdef __cplusplus //maks
extern "C" {
#endif

extern SDL_VideoDevice *current_video;

//extern const SDL_VideoDevice *SDL_GetCurrentVideo(); //maks
