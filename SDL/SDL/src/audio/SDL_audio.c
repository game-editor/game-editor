...
#ifdef SAVE_RCSID
static char rcsid =
 "@(#) $Id: SDL_audio.c,v 1.22 2004/02/11 07:26:29 slouken Exp $";
#endif
...
extern void Mix_PauseMIDI(int pauseon); //maks

#ifdef _WIN32_WCE
extern void SDL_PausePocketAudio(int bEnterPause); //maks
#endif
...
void SDL_PauseAudio (int pause_on)
{
	...
	//maks: this function don't stop native midi, so, go a little more...
	Mix_PauseMIDI(pause_on);

#ifdef _WIN32_WCE
	SDL_PausePocketAudio(pause_on);
#endif
