...
int SDL_KeyboardInit(void)
{
	...
	keynames[SDLK_POCKET_UP] =		"Pocket Up   ";
	keynames[SDLK_POCKET_DOWN] =	"Pocket Down ";
	keynames[SDLK_POCKET_LEFT] =	"Pocket Left ";
	keynames[SDLK_POCKET_RIGHT] =	"Pocket Right";

	keynames[SDLK_POCKET_A] =		"Pocket A    ";
	keynames[SDLK_POCKET_B] =		"Pocket B    ";
	keynames[SDLK_POCKET_C] =		"Pocket C    ";
	keynames[SDLK_POCKET_START] =	"Pocket Start";

	keynames[SDLK_POCKET_AUX1] =	"Pocket Auxiliary Key 1";
	keynames[SDLK_POCKET_AUX2] =	"Pocket Auxiliary Key 2";
	keynames[SDLK_POCKET_AUX3] =	"Pocket Auxiliary Key 3";
	keynames[SDLK_POCKET_AUX4] =	"Pocket Auxiliary Key 4";
	keynames[SDLK_POCKET_AUX5] =	"Pocket Auxiliary Key 5";
	keynames[SDLK_POCKET_AUX6] =	"Pocket Auxiliary Key 6";
	keynames[SDLK_POCKET_AUX7] =	"Pocket Auxiliary Key 7";
	keynames[SDLK_POCKET_AUX8] =	"Pocket Auxiliary Key 8";

	/*Maks: GP2X keys*/
	keynames[SDLK_GP2X_BUTTON_UP] =			"GP2X Joystick Up";
	keynames[SDLK_GP2X_BUTTON_DOWN] =		"GP2X Joystick Down";
	keynames[SDLK_GP2X_BUTTON_LEFT] =		"GP2X Joystick Left";
	keynames[SDLK_GP2X_BUTTON_RIGHT] =		"GP2X Joystick Right";
	keynames[SDLK_GP2X_BUTTON_UPLEFT] =		"GP2X Joystick Up Left";
	keynames[SDLK_GP2X_BUTTON_UPRIGHT] =	"GP2X Joystick Up Right";
	keynames[SDLK_GP2X_BUTTON_DOWNLEFT] =	"GP2X Joystick Down Left";
	keynames[SDLK_GP2X_BUTTON_DOWNRIGHT] =	"GP2X Joystick Down Right";
	keynames[SDLK_GP2X_BUTTON_CLICK] =		"GP2X Joystick Click";
	keynames[SDLK_GP2X_BUTTON_A] =			"GP2X Button A";
	keynames[SDLK_GP2X_BUTTON_B] =			"GP2X Button B";
	keynames[SDLK_GP2X_BUTTON_X] =			"GP2X Button X";
	keynames[SDLK_GP2X_BUTTON_Y] =			"GP2X Button Y";
	keynames[SDLK_GP2X_BUTTON_L] =			"GP2X Button L";
	keynames[SDLK_GP2X_BUTTON_R] =			"GP2X Button R";
	keynames[SDLK_GP2X_BUTTON_START] =		"GP2X Start";
	keynames[SDLK_GP2X_BUTTON_SELECT] =		"GP2X Select";
	keynames[SDLK_GP2X_BUTTON_VOLUP] =		"GP2X Volume Up";
	keynames[SDLK_GP2X_BUTTON_VOLDOWN] =	"GP2X Volume Down";

	/* Maks: famous Any Key*/
	keynames[SDLK_ANY_KEY]						=	"any key";
	keynames[SDLK_ALL_KEYS_PRESSED]				=	"All keys are pressed";
	keynames[SDLK_KEYS_PRESSED_IN_ORDER]		=	"Keys are pressed in order";
	keynames[SDLK_AT_LEAST_ONE_KEY_IS_PRESSED]	=	"At least one key is pressed";
...
SDLMod SDL_GetModState (void)
{
	...
	//Solve the shift selection even if shift is not pressed

	//Ctrl don't works on Win 95 if call WIN_GetKeyboardState() here
	/*void WIN_GetKeyboardState(void);
	WIN_GetKeyboardState();*/

	//Works on XP and 95
	//Check result (GetKeyboardState may be wrong)
	if( !((GetAsyncKeyState(VK_RSHIFT) & 0x8000) || //Don't works on Win 95, so continue the test
		((GetAsyncKeyState(VK_SHIFT) & 0x8000) && (SDL_ModState & KMOD_RSHIFT))) ) //some shift stay pressed?
	{
		//state |= KMOD_RSHIFT;
		SDL_ModState &= ~KMOD_RSHIFT;
	}
#endif
...
/*#if defined(WIN32) && defined(_DEBUG)
	...
	void dPrintf(char *s);
	char s[128];
	sprintf(s, "The '%s' key has been %s\n", SDL_GetKeyName(keysym->sym), 
...
/*#if defined(WIN32) && defined(_DEBUG)
	...
	void dPrintf(char *s);
	char s[128];
	sprintf(s, "SDL_ModState = %ld, keysym->sym = %ld, state = %ld\n", SDL_ModState, keysym->sym, state);
	dPrintf(s);
	}
#endif*/
