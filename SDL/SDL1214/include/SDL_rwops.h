...
Uint16 SDL_ReadLE16 (SDL_RWops *src); //AKR
Uint16 SDL_ReadBE16 (SDL_RWops *src); //AKR
Uint32 SDL_ReadLE32 (SDL_RWops *src); //AKR
Uint32 SDL_ReadBE32 (SDL_RWops *src); //AKR
Uint64 SDL_ReadLE64 (SDL_RWops *src); //AKR
Uint64 SDL_ReadBE64 (SDL_RWops *src); //AKR
int SDL_WriteLE16 (SDL_RWops *dst, Uint16 value); //AKR
int SDL_WriteBE16 (SDL_RWops *dst, Uint16 value); //AKR
int SDL_WriteLE32 (SDL_RWops *dst, Uint32 value); //AKR
int SDL_WriteBE32 (SDL_RWops *dst, Uint32 value); //AKR
int SDL_WriteLE64 (SDL_RWops *dst, Uint64 value); //AKR
int SDL_WriteBE64 (SDL_RWops *dst, Uint64 value); //AKR
