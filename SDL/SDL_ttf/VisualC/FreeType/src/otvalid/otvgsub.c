...
#define FT_COMPONENT  trace_otvgsub
                              ...
                              OTV_Validator  valid )
  {
    ...
    case 1:
      ...
      OTV_NEST2_( MultipleSubstFormat1, Sequence, MultipleSubstFormat1, Sequence ); //maks
      OTV_RUN( table, valid );
      break;
                               ...
                               OTV_Validator  valid )
  {
    ...
    case 1:
      valid->extra1 = valid->glyph_count;
      OTV_NEST2_( AlternateSubstFormat1, AlternateSet, AlternateSubstFormat1, AlternateSet ); //maks
      OTV_RUN( table, valid );
      break;
...
#define Ligature  otv_Ligature_validate, "Ligature"
                              ...
                              OTV_Validator  valid )
  {
    ...
    {
    case 1:
      OTV_NEST3_( LigatureSubstFormat1, LigatureSet, Ligature, LigatureSubstFormat1, LigatureSet, Ligature ); //maks
      OTV_RUN( table, valid );
      break;
                             ...
                             OTV_Validator  valid )
  {
    ...
    case 1:
      ...
      OTV_NEST3_( ContextSubstFormat1, SubRuleSet, SubRule, ContextSubstFormat1, SubRuleSet, SubRule ); //maks
      OTV_RUN( table, valid );
      break;
    ...
    case 2:
      ...
      OTV_NEST3_( ContextSubstFormat2, SubClassSet, SubClassRule, ContextSubstFormat2, SubClassSet, SubClassRule ); //maks
      OTV_RUN( table, valid );
      break;

    case 3:
      OTV_NEST1_( ContextSubstFormat3, ContextSubstFormat3 ); //maks
      OTV_RUN( table, valid );
      break;
                                  ...
                                  OTV_Validator  valid )
  {
    ...
    case 1:
      ...
      valid->extra1 = valid->lookup_count;
      OTV_NEST3_( ChainContextSubstFormat1, ChainSubRuleSet, ChainSubRule, ChainContextSubstFormat1, ChainSubRuleSet, ChainSubRule ); //maks
      OTV_RUN( table, valid );
      break;
    ...
    case 2:
      ...
      OTV_NEST3_( ChainContextSubstFormat2, ChainSubClassSet, ChainSubClassRule, ChainContextSubstFormat2, ChainSubClassSet, ChainSubClassRule ); //maks
      OTV_RUN( table, valid );
      break;

    case 3:
      OTV_NEST1_( ChainContextSubstFormat3, ChainContextSubstFormat3 ); //maks
      OTV_RUN( table, valid );
      break;
