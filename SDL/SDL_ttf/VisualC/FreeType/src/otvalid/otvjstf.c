...
#define JstfLookup    otv_GPOS_subtable_validate, ""
                             ...
                             OTV_Validator  valid )
  {
    ...
    if ( ShrinkageJstfMax )
    {
      ...
      OTV_NEST2_( JstfMax, JstfLookup, JstfMax, JstfLookup ); //maks
                           ...
                           OTV_Validator  valid )
  {
    ...
    if ( ExtGlyph )
    {
      ...
      OTV_NEST1_( ExtenderGlyph, ExtenderGlyph ); //maks
    ...
    if ( DefJstfLangSys )
    {
      OTV_NEST2_( JstfLangSys, JstfPriority, JstfLangSys, JstfPriority ); //maks
