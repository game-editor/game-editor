...
#define MarkMarkPosFormat1  otv_u_O_O_u_O_O, "MarkMarkPosFormat1"
                            ...
                            OTV_Validator  valid )
  {
    ...
    case 1:
      valid->extra2 = 0;
      OTV_NEST2_( MarkBasePosFormat1, BaseArray, MarkBasePosFormat1, BaseArray ); //maks
      OTV_RUN( table, valid );
      break;
                           ...
                           OTV_Validator  valid )
  {
    ...
    case 1:
      valid->extra2 = 1;
      OTV_NEST3_( MarkLigPosFormat1, LigatureArray, LigatureAttach, MarkLigPosFormat1, LigatureArray, LigatureAttach );
      OTV_RUN( table, valid );
      break;
                            ...
                            OTV_Validator  valid )
  {
    ...
    case 1:
      valid->extra2 = 0;
      OTV_NEST2_( MarkMarkPosFormat1, Mark2Array, MarkMarkPosFormat1, Mark2Array ); //maks
      OTV_RUN( table, valid );
      break;
                           ...
                           OTV_Validator  valid )
  {
    ...
    case 1:
      ...
      OTV_NEST3_( ContextPosFormat1, PosRuleSet, PosRule, ContextPosFormat1, PosRuleSet, PosRule ); //maks
      OTV_RUN( table, valid );
      break;
    ...
    case 2:
      ...
      OTV_NEST3_( ContextPosFormat2, PosClassSet, PosClassRule, ContextPosFormat2, PosClassSet, PosClassRule ); //maks
      OTV_RUN( table, valid );
      break;

    case 3:
      OTV_NEST1_ ( ContextPosFormat3, ContextPosFormat3 ); //maks
      OTV_RUN( table, valid );
      break;
                                ...
                                OTV_Validator  valid )
  {
    ...
    case 1:
      ...
      valid->extra1 = valid->lookup_count;
      OTV_NEST3_( ChainContextPosFormat1, ChainPosRuleSet, ChainPosRule, ChainContextPosFormat1, ChainPosRuleSet, ChainPosRule ); //maks
      OTV_RUN( table, valid );
      break;
    ...
    case 2:
      ...
      OTV_NEST3_( ChainContextPosFormat2, ChainPosClassSet, ChainPosClassRule, ChainContextPosFormat2, ChainPosClassSet, ChainPosClassRule ); //maks
      OTV_RUN( table, valid );
      break;

    case 3:
      OTV_NEST1_( ChainContextPosFormat3, ChainContextPosFormat3 ); //maks
      OTV_RUN( table, valid );
      break;
