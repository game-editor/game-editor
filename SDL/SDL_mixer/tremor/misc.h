...
extern int ABS(int a); //maks

//#if BYTE_ORDER==LITTLE_ENDIAN
#if SDL_BYTEORDER == SDL_LIL_ENDIAN //maks
...
static inline ogg_int32_t MULT32(ogg_int32_t x, ogg_int32_t y) {
  union magic_tremor magic_tremor;
  magic_tremor.whole = (ogg_int64_t)x * y;
  return magic_tremor.halves.hi;
}
...
static inline ogg_int32_t MULT31_SHIFT15(ogg_int32_t x, ogg_int32_t y) {
  union magic_tremor magic_tremor;
  magic_tremor.whole  = (ogg_int64_t)x * y;
  return ((ogg_uint32_t)(magic_tremor.halves.lo)>>15) | ((magic_tremor.halves.hi)<<17);
}
...
extern int _ilog(unsigned int v); //maks
