...
static int mapping0_inverse(vorbis_block *vb,vorbis_look_mapping *l){
  ...
  ogg_int32_t **pcmbundle=(ogg_int32_t **)_ogg_malloc(sizeof(*pcmbundle)*vi->channels); //maks
  int    *zerobundle=(int *)_ogg_malloc(sizeof(*zerobundle)*vi->channels); //maks  
  int   *nonzero  =(int *)_ogg_malloc(sizeof(*nonzero)*vi->channels); //maks
  void **floormemo=(void **)_ogg_malloc(sizeof(*floormemo)*vi->channels); //maks
  ...
  _ogg_free(pcmbundle); //maks
  _ogg_free(zerobundle); //maks
  _ogg_free(nonzero); //maks
  _ogg_free(floormemo); //maks
