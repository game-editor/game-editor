...
char *gedStrDup( const char *strSource); //maks
...
//extern BOOL MD_DropPrivileges(void); //maks
#endif
...
extern void _mm_unregisterdrivers(void); //maks
extern void _mm_registerloader(struct MLOADER*);
extern void _mm_unregisterloaders(void); //maks
