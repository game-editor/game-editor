...
MIKMODAPI extern void   MikMod_UnregisterAllDrivers(void); //maks
...
MIKMODAPI extern void    MikMod_UnregisterAllLoaders(void); //maks
...
MIKMODAPI extern MODULE* Player_LoadRWFromFile(CHAR*,int,BOOL); 
#endif /* USE_RWOPS */
