...
void FormMain::OnSelectStyle( wxCommandEvent& WXUNUSED(event) )
{
...

    {
        ...
        ADD_FLAG(wxPG_EX_TRADITIONAL_VALIDATORS)
...
void FormMain::PopulateWithExamples ()
{
    ...
    prop->SetAttribute(wxPG_FILE_SHOW_FULL_PATH,(long)0);
                ...
                wxTAB_TRAVERSAL|wxCLOSE_BOX|wxNO_FULL_REPAINT_ON_RESIZE) )
{
    ...
    menuTry->Append(ID_ENABLECOMMONVALUES, wxT("Use Common Values"),
        wxT("Enable values that are common to all properties."));
    menuTry->AppendSeparator();
