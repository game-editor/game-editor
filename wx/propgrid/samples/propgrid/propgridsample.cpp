...
// NOTES
//
// * At the top of the file, there are examples of custom property classes.
//
...
WX_PG_IMPLEMENT_STRING_PROPERTY(wxTestStringProperty)
...
{
    //wxASSERT ( m_proped );
    //wxVariant values = m_proped->GetPropertyValues(wxT("Test"),m_proped->GetRoot(),wxPG_KEEP_STRUCTURE);
...
#define FLAG_TEST_SET2 (wxSTAY_ON_TOP|wxCAPTION|wxICONIZE|wxSYSTEM_MENU)
...

    {
        ...
        wxVariant pg1_values = pgadv->GetPropertyValues(wxT("Page1"),NULL,wxPG_KEEP_STRUCTURE);
        pgadv->SetTargetPage(1);
        wxVariant pg2_values = pgadv->GetPropertyValues(wxT("Page2"),NULL,wxPG_KEEP_STRUCTURE);
        pgadv->SetTargetPage(2);
        wxVariant pg3_values = pgadv->GetPropertyValues(wxT("Page3"),NULL,wxPG_KEEP_STRUCTURE);
...
void FormMain::PopulateWithExamples ()
{
    ...
    pg->SetPropertyHelpString( wxT("SpinCtrl"),
        ...
        wxT("changed to wxPG_EDITOR(SpinCtrl) - which, by the way, ")
        wxT("is a custom editor defined in this sample app."));
    ...
    wxPGChoices tchoices(mcStrings);
    ...
    //pg->Append ( wxEnumProperty(wxT("EnumProperty X2"),wxPG_LABEL, tchoices ) );
...
# endif
    ...
    wxPropertyGridManager* pgadv = m_pPropGridMan = new wxPropertyGridManager(panel, PGID/*-1*/,
        wxDefaultPosition, wxDefaultSize,
        wxPG_BOLD_MODIFIED |
    ...
    pgadv->SetExtraStyle(wxPG_EX_MODE_BUTTONS);
    ...
    //pgadv->SetPropertyAttributeAll(wxPG_BOOL_USE_DOUBLE_CLICK_CYCLING,(long)1);
    //pgadv->SetPropertyAttributeAll(wxPG_BOOL_USE_CHECKBOX,(long)1);
...
void SampleFrame::OnComboItemPaint(wxPGOwnerDrawnComboBox* pCb,
                                   int item,
                                   wxDC& dc,
                                   wxRect& rect,
                                   int flags )
               ...
               (wxMINIMIZE_BOX|wxMAXIMIZE_BOX|wxRESIZE_BORDER|wxSYSTEM_MENU|wxCAPTION|wxCLOSE_BOX|wxTAB_TRAVERSAL|wxNO_FULL_REPAINT_ON_RESIZE) )
{
    ...
    m_odc = new wxPGOwnerDrawnComboBox(this,1,wxEmptyString,
                                     wxDefaultPosition, wxDefaultSize,
                                     arrItems,
    ...
    //
    rowSizer = new wxBoxSizer ( wxHORIZONTAL );
    rowSizer->Add( new wxStaticText(this,-1,wxT("List View Combo:")), 0,
                   wxALIGN_CENTER_VERTICAL|wxRIGHT,
                   4
                 );
    ...
    m_odc2 = new wxPGOwnerDrawnComboBox(this,2,wxEmptyString,
                                     wxDefaultPosition, wxDefaultSize,
                                     iface,
                                     wxNO_BORDER
                                    );
    ...
    m_odc3 = new wxPGOwnerDrawnComboBox(this,3,wxEmptyString,
                                     wxDefaultPosition, wxDefaultSize,
                                     iface2
                                    );
    ...
    topSizer->Add( pg, 1, wxEXPAND|wxALL, 5 );
