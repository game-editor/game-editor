...
//
    ...
    wxPG_ICON_WIDTH             9 // comment to use bitmap buttons
    #define wxPG_USE_RENDERER_NATIVE    0 // 1 if wxRendererNative should be employed
...
// (for tree buttons)
#undef wxPG_ICON_WIDTH //maks:teste
...
#define wxPG_PROP_CATEGORY_LOOK		0x0100 //maks
...
public:
    ...
    */
	...
	virtual bool SetValueFromDouble ( double value, int flags = 0 ); //maks
	virtual double GetValueAsDouble (); //maks
	virtual bool GetValueAsBool(); //maks
	virtual void SetValueFromBool(bool value); //maks
    ...
    */
    ...
    inline bool IsFlagSet( unsigned long flag ) const //maks
    {
    ...
    */
    ...
    inline unsigned long GetFlags() const //maks
    {
        return m_flags;
    }

	inline unsigned long GetExtraFlags() const //maks
    {
        return m_extraFlags;
    }

	void SetExtraFlags(unsigned int flags) //maks
    {
        m_extraFlags = flags;
    }
    ...
    */
    ...
    inline void SetFlag( unsigned long flag ) { m_flags |= flag; } //maks
    ...
    */
    ...
    inline void ClearFlag( unsigned long flag ) { m_flags &= ~(flag); } //maks
	...
	void SetToolTip(wxString s); //maks
	wxString GetToolTip() {return m_tooltip;} //maks
...
protected:
    ...
    unsigned long               m_flags; // This could be short int. //maks
	unsigned long               m_extraFlags; //maks
...
public:
    ...
    */
    ...
    wxPGId AddChild ( wxPGProperty* prop ); //maks
...
//extern WXDLLIMPEXP_PG wxPGChoicesData* g_wxPG_emptyChoicesData;
...
void SetFloatConstraints(wxPGProperty *p, double _min, double _max, double _increment ); //maks
void GetFloatConstraints(wxPGProperty *p, double &_min, double &_max, double &_increment ); //maks

WX_PG_DECLARE_STRING_PROPERTY_WITH_DECL(wxDirProperty,WXDLLIMPEXP_PG)

// Enum and Flags Properties require special attention.
extern WXDLLIMPEXP_PG wxPGProperty* wxEnumProperty( const wxString&, const wxString&,
...
extern WXDLLIMPEXP_PG wxPGProperty* wxEditEnumProperty( const wxString&, const wxString&,
    const wxChar** labels = (const wxChar**) NULL,
    const long* values = NULL, const wxString& value = wxEmptyString );

extern WXDLLIMPEXP_PG wxPGProperty* wxEditEnumProperty( const wxString&, const wxString&,
    const wxArrayString& labels, const wxArrayInt& values, const wxString& value = wxEmptyString );
extern WXDLLIMPEXP_PG wxPGProperty* wxEditEnumProperty( const wxString&, const wxString&,
...
extern WXDLLIMPEXP_PG wxPGProperty* wxFlagsProperty( const wxString&, const wxString&,
    const wxArrayString& labels, const wxArrayInt& values, int value = 0 );
extern WXDLLIMPEXP_PG wxPGProperty* wxFlagsProperty( const wxString&, const wxString&,
    const wxArrayString& labels, int value = 0 );
...
public:
    ...
    {
        SelectProperty(wxPGIdGen((wxPGProperty*)NULL));
    }
    ...
    void SelectProperty( wxPGProperty* p, bool focus = false );
...
public:
    ...
    */
    ...
    /** Returns wxPGChoices* matching the id. If not found,
        NULL is returned.
    */
    //static wxPGChoices* GetChoicesArray(size_t id);
...
#else
    inline bool IsPropertyUnspecified ( wxPGPropNameStr name ) { return IsPropertyValueUnspecified(GetPropertyByName(name)); }
#endif
...
#define wxPG_SEL_BY_CLICK   0x08 // maks
...
public:
    ...
    */
    inline bool Collapse ( wxPGId id ) { return Collapse(wxPGIdToPtr(id)); }
    ...
    */
    inline bool Expand ( wxPGId id ) { return Expand(wxPGIdToPtr(id)); }
    ...
    */
    ...
    {
        SelectProperty(wxPGIdToPtr(id),focus?wxPG_SEL_FOCUS:0);
    }
    inline void SelectProperty ( wxPGPropNameStr name, bool focus = false )
    {
        SelectProperty(wxPGIdToPtr(GetPropertyByName(name)),focus?wxPG_SEL_FOCUS:0);
    }
    ...
    */
    ...
    /** Property is be hidden/shown when hider button is toggled or
        when wxPropertyGrid::Compact is called.
    */
    inline void SetPropertyPriority ( wxPGPropNameStr name, int priority )
    {
    ...
    */
    ...
    /** Sets value (long integer) of a property. */
    inline void SetPropertyValue ( wxPGPropNameStr name, long value )
    {
    ...
    /** Sets value (floating point) of a property. */
    inline void SetPropertyValue ( wxPGPropNameStr name, double value )
    {
        SetPropertyValue ( GetPropertyByName(name), wxPG_VALUETYPE(double), wxPGVariantFromDouble(value) );
    }
    /** Sets value (bool) of a property. */
    inline void SetPropertyValue ( wxPGPropNameStr name, bool value )
    {
    ...
    */
    inline void SetPropertyValue ( wxPGPropNameStr name, const wxString& value )
    {
    ...
    */
    ...
    /** Sets value (wxArrayString) of a property. */
    inline void SetPropertyValue ( wxPGPropNameStr name, const wxArrayString& value )
    {
    ...
    /** Sets value (wxPoint&) of a property. */
    inline void SetPropertyValue ( wxPGPropNameStr name, const wxPoint& value )
    {
        SetPropertyValue ( GetPropertyByName(name), value );
    }
    /** Sets value (wxSize&) of a property. */
    inline void SetPropertyValue ( wxPGPropNameStr name, const wxSize& value )
    {
        SetPropertyValue ( GetPropertyByName(name), value );
    }
    /** Sets value (wxArrayInt&) of a property. */
    inline void SetPropertyValue ( wxPGPropNameStr name, const wxArrayInt& value )
    {
        SetPropertyValue ( GetPropertyByName(name), value );
    }
    ...
    */
    ...
    {
        SetPropertyUnspecified ( GetPropertyByName(name) );
    }
    ...
    */
    ...
    //
    void SelectProperty ( wxPGProperty* p, unsigned int flags = 0 );
    ...
    wxPGProperty *GetPropHover() {return m_propHover;} //maks
	void ClearPropHover() {m_propHover = NULL;} //maks
...
protected:
	...
	bool HandleMouseDoubleClick( int x, unsigned int y, wxMouseEvent &event ); //maks
...
protected:
    ...
    */
    ...
    bool Expand ( wxPGProperty* p, bool sendEvent = false );

    bool Collapse ( wxPGProperty* p, bool sendEvent = false );
...
BEGIN_DECLARE_EVENT_TYPES()
    ...
    DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_PG, wxEVT_PG_DOUBLE_CLICK,        1782) //maks
	DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_PG, wxEVT_PG_TOOL_BAR_CLICK,        1783) //maks
	DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_PG, wxEVT_PG_SELECT,        1784) //maks
END_DECLARE_EVENT_TYPES()
    ...
    enum {
		...
		wxEVT_PG_DOUBLE_CLICK, //maks
		wxEVT_PG_TOOL_BAR_CLICK, //maks
		wxEVT_PG_SELECT //maks
    };
#endif
...
#define EVT_PG_DOUBLE_CLICK(id, fn)           DECLARE_EVENT_TABLE_ENTRY( wxEVT_PG_DOUBLE_CLICK, id, -1, (wxObjectEventFunction) (wxEventFunction)  wxStaticCastEvent( wxPropertyGridEventFunction, & fn ), (wxObject *) NULL ), //maks
#define EVT_PG_TOOL_BAR_CLICK(id, fn)           DECLARE_EVENT_TABLE_ENTRY( wxEVT_PG_TOOL_BAR_CLICK, id, -1, (wxObjectEventFunction) (wxEventFunction)  wxStaticCastEvent( wxPropertyGridEventFunction, & fn ), (wxObject *) NULL ), //maks
#define EVT_PG_SELECT(id, fn)              DECLARE_EVENT_TABLE_ENTRY( wxEVT_PG_SELECT, id, -1, (wxObjectEventFunction) (wxEventFunction)  wxStaticCastEvent( wxPropertyGridEventFunction, & fn ), (wxObject *) NULL ), //maks
