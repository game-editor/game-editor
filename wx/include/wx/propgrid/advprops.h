...
WX_PG_DECLARE_PROPERTY_WITH_DECL(wxTreeProperty,wxString,wxT(""),WXDLLIMPEXP_PG) //maks
#if wxUSE_IMAGE
#include <wx/image.h>
...
class wxTreePropertyClass : public wxEnumPropertyClass //maks
{
    WX_PG_DECLARE_DERIVED_PROPERTY_CLASS()
public:

    wxTreePropertyClass ( const wxString& label, const wxString& name, wxString value );
    virtual ~wxTreePropertyClass ();
