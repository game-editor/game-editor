...
public:
    ...
    virtual void* GetClientData( int item ) const; //maks
	...
	virtual void Populate ( int n, const wxString choices[], void **data = NULL ); //maks
	...
	wxPGOwnerDrawnComboBox*   GetCombo() {return m_combo;} //maks
...
public:
	...
	wxString GetValueString() {return m_valueString;} //maks
...
#define wxODCB_TREE  0x2000 //maks
...
// a combo control needs a control for popup window it displays
    ...
    void ShowPopup();
    void HidePopup( bool sendEvent = true, wxCommandEvent *pEvent = NULL ); //maks
